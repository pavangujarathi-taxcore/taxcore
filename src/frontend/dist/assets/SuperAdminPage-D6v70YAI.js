import { f as createLucideIcon, ac as useTheme, r as reactExports, s as storage, o as onStorageChange, j as jsxRuntimeExports, U as Users, ad as Star, C as CircleCheckBig, I as Input, B as Button, b as Eye, L as Label, S as ShieldCheck, ae as LayoutDashboard, D as Dialog, p as DialogContent, t as DialogHeader, v as DialogTitle, ab as saveUsersNow, u as ue } from "./index-D5ov2zgF.js";
import { B as Badge } from "./badge-B134Uopm.js";
...
function FirmDetailsModal({
  ...
  const totalClients = clients.filter(
    (c) => ownerUser && (c.firmId === ownerUser.id || c.createdBy === ownerUser.id)
  ).length;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: !!firm, onOpenChange: () => onClose(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-sm", "data-ocid": "super-admin.details_modal", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 mt-1", children: [
      ...
      firm.firmNumber && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-blue-200 bg-blue-50 px-3 py-2 flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-blue-600 uppercase tracking-wide font-semibold", children: "Firm ID" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono font-bold text-blue-800 text-sm tracking-wider", children: firm.firmNumber })
      ] }),
...
function SuperAdminPage() {
  ...
  function getFirmClientCount(firm) {
    ...
    const firmId = ownerUser.firmId ?? ownerUser.id;
    return clients.filter(
      (c) => c.firmId === firmId || c.firmId === ownerUser.id || c.createdBy === ownerUser.id
    ).length;
  }
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "tr",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 px-4 whitespace-nowrap", children: f.firmNumber ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center px-2 py-0.5 rounded text-xs font-mono font-semibold bg-blue-50 text-blue-700 border border-blue-100", children: f.firmNumber }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-400 italic", children: "—" }) }),
