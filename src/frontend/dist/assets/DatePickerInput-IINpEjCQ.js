import { f as createLucideIcon, a9 as React, r as reactExports, j as jsxRuntimeExports, a4 as cn, aa as buttonVariants, B as Button$1, a2 as useControllableState, a3 as useId, N as useComposedRefs, V as Primitive, O as composeEventHandlers, P as Presence, M as Portal$1, T as hideOthers, Z as ReactRemoveScroll, Q as createContextScope, a0 as createSlot, Y as useFocusGuards, _ as FocusScope, $ as DismissableLayer, I as Input } from "./index-D5ov2zgF.js";
import { i as ChevronDown, R as Root2$1, A as Anchor, e as createPopperScope, C as Content, g as Arrow, S as Select$1, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-BIhiYm88.js";
/**
...
function formatToDD_MM_YYYY(date) {
...
function DatePickerInput({
  ...
  const selectedDate = parseDDMMYYYY(value) || void 0;
  const [calendarMonth, setCalendarMonth] = reactExports.useState(
    selectedDate ?? /* @__PURE__ */ new Date()
  );
  const handleOpenChange = (open) => {
    if (open) {
      setCalendarMonth(selectedDate ?? /* @__PURE__ */ new Date());
    }
    setCalOpen(open);
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex gap-1 ${className}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Input,
      {
        ...
        className: "flex-1",
        style: {
          color: value ? void 0 : "#9ca3af"
        }
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Popover, { open: calOpen, onOpenChange: handleOpenChange, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button$1,
        {
          ...
          title: "Open calendar",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar$1, { className: "h-4 w-4 text-gray-500" })
        }
      ) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(PopoverContent, { className: "w-auto p-0", align: "end", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 px-3 pt-3 pb-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Select$1,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "h-7 text-xs flex-1 min-w-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: MONTHS.map((month, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  SelectItem,
                  {
                    value: String(idx),
                    className: "text-xs",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Select$1,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "h-7 text-xs w-[72px] flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: yearOptions.map((year) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  SelectItem,
                  {
                    value: String(year),
                    className: "text-xs",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Calendar,
          {
            ...
            disabled: maxDate || minDate ? isDisabled : void 0,
            initialFocus: true
          }
        )
      ] })
