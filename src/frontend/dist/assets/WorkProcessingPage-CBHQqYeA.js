import { r as reactExports, o as onStorageChange, a8 as getFilingStatus, j as jsxRuntimeExports, I as Input, C as CircleCheckBig, s as storage, u as ue } from "./index-D5ov2zgF.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white rounded-lg shadow-sm border overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
        rows.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 10, className: "py-8 text-center text-gray-400", children: "No work records found" }) }),
        rows.map((row, i) => {
