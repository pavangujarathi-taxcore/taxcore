import { f as createLucideIcon, r as reactExports, K as useCallbackRef, j as jsxRuntimeExports, P as Presence, M as Portal$1, N as useComposedRefs, O as composeEventHandlers, Q as createContextScope, T as hideOthers, V as Primitive, W as dispatchDiscreteCustomEvent, Y as useFocusGuards, Z as ReactRemoveScroll, _ as FocusScope, $ as DismissableLayer, a0 as createSlot, a1 as composeRefs, a2 as useControllableState, a3 as useId, a4 as cn, a5 as Pencil } from "./index-D5ov2zgF.js";
import { u as useDirection, R as Root2$1, A as Anchor, e as createPopperScope, f as createCollection, C as Content, g as Arrow, h as Check } from "./select-BIhiYm88.js";
import { I as Item, c as createRovingFocusGroupScope, R as Root } from "./index-C_NlLzNf.js";
/**
...
function InlineStatusCell({
  ...
  const [isGlowing, setIsGlowing] = reactExports.useState(false);
  const cellRef = reactExports.useRef(null);
  const glowTimer = reactExports.useRef(null);
  const currentOption = options.find((o) => o.value === value);
  const colorClass = (currentOption == null ? void 0 : currentOption.colorClass) ?? "bg-gray-100 text-gray-500";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        ...
        borderRadius: "6px",
        ...isGlowing ? {
          boxShadow: "0 0 0 2px #16a34a, 0 0 10px 2px rgba(22, 163, 74, 0.35)",
      ...
      ` }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuContent, { align: "start", className: "min-w-[130px] p-1", children: options.map((opt) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            DropdownMenuItem,
            {
              ...
              children: [
                ...
                opt.value === value && /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-3 h-3 ml-auto text-emerald-600 flex-shrink-0" })
              ]
            },
            opt.value
          )) })
