import { f as createLucideIcon, r as reactExports, g as getDeadlineAlertClients, h as getEVerificationAlerts, s as storage, o as onStorageChange, j as jsxRuntimeExports, R as RefreshCw, U as Users, C as CircleCheckBig, S as ShieldCheck, i as ShieldAlert, B as Button, k as getClientWork, l as getLatestDocStatus, m as getPanCategory, a as refreshFromCanister, u as ue, n as getLatestDoc, q as queueDueDateNotifications } from "./index-D5ov2zgF.js";
import { M as MessageSquare, C as Card, a as CardHeader, b as CardTitle, c as CardContent } from "./card-BsRWf-Ms.js";
...
function computeStats(taxYear, userId, userRole) {
  ...
  const totalClients = taxYear === "All" ? accessibleClients.length : accessibleClients.filter((c) => c.taxYear === taxYear).length;
  const displayClients = taxYear === "All" ? accessibleClients : accessibleClients.filter((c) => c.taxYear === taxYear);
  ...
  const filteredWork = taxYear === "All" ? scopedWork : scopedWork.filter((w) => w.taxYear === taxYear);
...
function DashboardPage({ user }) {
  ...
  const getTabClients = () => {
    ...
    if (activeTab === "pendingITR")
      return stats.clients.filter((c) => {
        const w = filteredWork.find((fw) => fw.clientId === c.id);
        return (w == null ? void 0 : w.status) === "Completed";
      });
    ...
    activeTab === "eVerified" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", "data-ocid": "dashboard.everified.section", children: [
            ...
            "tr",
            {
              ...
              children: [
                ...
                "th",
                {
                  ...
                  style: {
                    color: "#fff",
                    width: h === "Sr.No." ? "52px" : void 0,
                    textAlign: h === "Sr.No." ? "center" : void 0
                  },
                  children: h
                },
                h
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "shadow-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "px-3 pb-3 pt-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
            (activeTab === "total" ? stats.recentClients : tabClients).map((client, idx) => {
              const work = getClientWork(client.id);
