import { r as reactExports, j as jsxRuntimeExports, B as Button, a5 as Download, a6 as Upload, L as Label, I as Input, u as ue, s as storage, k as getPanCategory } from "./index-phMI_H9e.js";
import { F as FileSpreadsheet } from "./file-spreadsheet-Cp8t9bWv.js";
import { C as CircleCheck, a as CircleAlert } from "./circle-check-0H-17lng.js";
...
function ImportPage() {
  ...
  const [duplicateCount, setDuplicateCount] = reactExports.useState(0);
  ...
  const handleDownloadTemplate = () => {
    ...
    utils.book_append_sheet(wb, ws, "Client Template");
    ws["!cols"] = [
      { wch: 20 },
      // Name
      { wch: 15 },
    ...
    writeFileSync(
      wb,
      `TaxCore_Import_Template_${(/* @__PURE__ */ new Date()).toLocaleDateString("en-IN").replace(/\//g, "-")}.xlsx`
    );
    ue.success("Template downloaded successfully!");
  };
  ...
  const handleImport = async () => {
    if (!file) {
      ue.error("Please select a file to import");
      return;
    }
    ...
    try {
      ...
      for (const row of jsonData) {
        ...
        const client = {
          ...
          clientType: row["Client Type"] || "Existing",
          headOfIncome: row["Head of Income"] || "Salaried",
          ...
          createdBy: (ownerUser == null ? void 0 : ownerUser.id) || "system"
        };
      ...
      ue.success(`Successfully imported ${imported} clients!`);
      ...
      setImportStatus("error");
      ue.error("Failed to import file. Please check the file format.");
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 max-w-3xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500", children: "Upload an Excel file to bulk import client data into TaxCore" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(FileSpreadsheet, { className: "w-5 h-5", style: { color: "#2563EB" } })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-600 mb-3", children: "Download the Excel template with sample data and required column headers" }),
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(FileSpreadsheet, { className: "w-5 h-5", style: { color: "#D97706" } })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h3",
                {
                  className: "font-semibold text-sm",
                  style: { color: "#D97706" },
                  children: "Fill Template with Client Data"
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-600", children: "Open the template in Excel/Google Sheets and fill in your client details" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "text-xs text-gray-500 mt-2 space-y-0.5 list-disc list-inside", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Required fields:" }),
                " Name, PAN, Mobile, Tax Year, Due Date"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "PAN Format:" }),
                " ABCPK1234F (5 letters, 4 digits, 1 letter)"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Due Date Format:" }),
                " DD-MM-YYYY (e.g., 31-07-2025)"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Head of Income:" }),
                " Salaried, Business, Agricultural, or Capital Gain"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Client Type:" }),
                " Existing or New"
              ] })
            ] })
          ] })
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Upload, { className: "w-5 h-5", style: { color: "#16A34A" } })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h3",
                {
                  className: "font-semibold text-sm",
                  style: { color: "#16A34A" },
                  children: "Upload & Import"
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-600 mb-3", children: "Upload your filled Excel file to import clients" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                file && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-gray-500 mt-1", children: [
                  "Selected: ",
                  file.name
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
                {
                  ...
                  children: [
                    ...
                    importStatus !== "validating" && importStatus !== "importing" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    importStatus === "success" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-sm text-green-800", children: "Import Successful!" }),
    ...
    importStatus === "error" && validationErrors.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CircleX, { className: "w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-sm text-red-800", children: "Validation Errors Found" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-red-700 mt-0.5", children: "Please fix the following errors in your Excel file and try again:" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-h-60 overflow-y-auto space-y-1.5", children: validationErrors.map((err) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-gray-700 mb-1", children: "Import Notes:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-0.5 list-disc list-inside", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Duplicate clients (same PAN) will be skipped automatically" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "All validation must pass before import begins" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Excel files (.xlsx, .xls) are supported" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Maximum recommended: 500 clients per file" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Imported clients will be assigned to the current owner account" })
          ] })
        ]
      }
    )
